export const works=[
{slug:'floral',title:'ЛИНИЯ ЦВЕТЕНИЯ',category:'Флористика',image:'floral.webp',number:'01',source:81,description:'Крупные лепестки, чёрные акценты и свободное движение линий. Цветы продолжают форму тела.'},
{slug:'cathedral',title:'ТИШИНА В ДЕТАЛЯХ',category:'Графика',image:'cathedral.webp',number:'02',source:84,description:'Готическая архитектура в тонкой графике. Шпили, арки и свет собираются в маленький мир на коже.'},
{slug:'snake',title:'ДИКИЙ ХАРАКТЕР',category:'Олдскул',image:'snake.webp',number:'03',source:66,description:'Змея на колене: выразительный контур, классический характер и движение, которое живёт вместе с телом.'},
{slug:'angel',title:'МАЛЕНЬКИЙ БУНТ',category:'Олдскул',image:'angel.webp',number:'04',source:77,description:'Небольшой ангел с сильным характером. Плотный контур и деликатный цветной акцент.'},
